...
param <- c("capa", "pre_rank.home", "pre_rank.away", "media", "section", "home_team", "away_team","hour","week","rain", "pre_win_rate.home", "pre_win_rate.away")
explain <- c("スタジアムの収容人数", "前節のランキング(home)","前節のランキング(away)", "tv局数", "節", "ホームチーム", "アウェイチーム", "開始時刻", "1(土日祝)、0(平日)", "1(雨)、0(雨以外)","ピタゴラス勝率(home)","ピタゴラス勝率(away)")
...
###CSV出力(ヘッダーなし)
write.table(submit, file="../submit/submit_20171128_1_lm.csv",
