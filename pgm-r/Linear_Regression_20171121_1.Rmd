---
title : データサイエンティスト養成講座  Jリーグ観客動員数を予測せよ！【練習問題】
...
モデル作成用のカラム
```{r}
param <- c("capa", "pre_rank", "media", "stage", "section", "home_team", "away_team","hour","week","rain")
explain <- c("スタジアムの収容人数", "前節のランキング", "tv局数", "開催大会", "節", "ホームチーム", "アウェイチーム", "開始時刻", "1(土日祝)、0(平日)", "1(雨)、0(雨以外)")
...
###CSV出力(ヘッダーなし)
write.table(submit, file="../submit/submit_20171121_1_lm.csv",
